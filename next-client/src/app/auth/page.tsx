...
export default function AuthPage() {
    ...
    return (
        <div style={{ minHeight: '100vh', background: '#0a0e1a', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '20px', position: 'relative', overflow: 'hidden' }}>
            {/* Background glows */}
            ...
            <div style={{ width: '100%', maxWidth: 480, position: 'relative', zIndex: 1 }}>
                ...
                >
                    <Link href="/" style={{ textDecoration: 'none', display: 'inline-flex', alignItems: 'center', gap: 10 }}>
                        <div style={{ width: 44, height: 44, borderRadius: 12, background: 'linear-gradient(135deg, #22c55e, #16a34a)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 22, boxShadow: '0 8px 24px rgba(34,197,94,0.4)' }}>🏏</div>
                        <span style={{ fontSize: 26, fontWeight: 900, color: '#f8fafc', letterSpacing: '-0.03em' }}>CricVerse</span>
                    </Link>
                    <p style={{ color: '#94a3b8', fontSize: 14, marginTop: 8 }}>
                        {mode === 'login' ? 'Welcome back, champion 🏆' : 'Join 10,000+ cricket players 🏏'}
                    </p>
                </motion.div>
